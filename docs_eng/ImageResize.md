...
- crop_pad_position
    ...
    - Python dtype: float
- pad_feathering
    - Adjustments to the plume effect of filling are important for creating smooth transitions between the original and filled areas of the image and for improving overall visual quality.
    - Comfy dtype: INT
    - Python dtype: int
- mask_optional
